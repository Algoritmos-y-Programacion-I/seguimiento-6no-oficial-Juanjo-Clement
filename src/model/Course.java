...
import customExceptions.LateRegistratedException;
import customExceptions.AlreadyActive;
import customExceptions.NotAmmitedCancelation;
...
public class Course {
	...
	public void enroll(String id) throws QuotaEnrollExceedException, LateRegistratedException, AlreadyActive{
		if (currentWeek>2){
			throw new LateRegistratedException();
		}
	...
	public void cancelEnrollment(String id) throws NotAmmitedCancelation{
		...
		if (assignedGrades >  totalGradesAmount / 2){
			throw new NotAmmitedCancelation();
		}
